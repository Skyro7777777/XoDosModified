...
import com.xodos.x11.input.InputEventSender;
...
import static com.xodos.x11.CmdEntryPoint.ACTION_START;
...
import com.xodos.x11.controller.winhandler.TaskManagerDialog;
...
import com.xodos.x11.utils.FullscreenWorkaround;
...
import com.xodos.x11.utils.X11ToolbarViewPager;
...
public class MainActivity extends LoriePreferences {
    static final String ACTION_STOP = "com.xodos.x11.ACTION_STOP";
    public static final String ACTION_CUSTOM = "com.xodos.x11.ACTION_CUSTOM";
    static final String REQUEST_LAUNCH_EXTERNAL_DISPLAY = "request_launch_external_display";
    public xodosX11ExtraKeys mExtraKeys;
    ...
    boolean usexodosEKBarBehaviour = false;
...
//        preferences.registerOnSharedPreferenceChangeListener((sharedPreferences, key) -> onPreferencesChanged(key));
        ...
        findViewById(R.id.preferences_button).setOnClickListener((l) -> {
            if (null != xodosActivityListener) {
                xodosActivityListener.onX11PreferenceSwitchChange(true);
            }
        });
...
if (e.getDevice() == null) {
       return mInputHandler.sendKeyEvent(e);
            ...
            if (k == KEYCODE_BACK) {
                ...
                if (null != xodosActivityListener && !mEnableFloatBallMenu) {
                    if (e.getAction() == ACTION_UP) {
                        releaseSlider(true);
                    }
                }
...
handledByInputHandler = mInputHandler.sendKeyEvent(e);
  ...
  //  }
            ...
            if (usexodosEKBarBehaviour && mExtraKeys != null && (dev == null || dev.isVirtual()))
...
//                    getIntent().putExtra(null, bundle);
    ...
    protected void onPreferencesChanged(String key) {
        ...
        if (key.contentEquals("enableFloatBallMenu") ||
            ...
            if (xodosActivityListener != null) {
                xodosActivityListener.setFloatBallMenu(mEnableFloatBallMenu, enableGlobalFloatBallMenu);
            }
            return;
        }
    ...
    void onPreferencesChangedCallback() {
        ...
        usexodosEKBarBehaviour = prefs.usexodosEKBarBehaviour.get();
    ...
    private void setTerminalToolbarView() {
        ...
        layoutParams.height = Math.round(37.5f * getResources().getDisplayMetrics().density *
            (xodosX11ExtraKeys.getExtraKeysInfo() == null ? 0 : xodosX11ExtraKeys.getExtraKeysInfo().getMatrix().length));
...
//    int orientation;
    ...
    public void onConfigurationChanged(@NonNull Configuration newConfig) {
        ...
        if (xodosActivityListener != null) {
            ...
            if (!forceLandscape) {
                xodosActivityListener.onChangeOrientation(newConfig.orientation);
            } else {
                xodosActivityListener.onChangeOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            }
            handler.postDelayed(() -> {
