...
import com.xodos.x11.controller.InputControllerActivity;
import com.xodos.x11.controller.container.Container;
import com.xodos.x11.controller.container.Shortcut;
import com.xodos.x11.controller.contentdialog.ContentDialog;
import com.xodos.x11.controller.core.Callback;
import com.xodos.x11.controller.core.DownloadProgressDialog;
...
public class LoriePreferences extends AppCompatActivity implements PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    static final String ACTION_PREFERENCES_CHANGED = "com.xodos.x11.ACTION_PREFERENCES_CHANGED";
...
public boolean isActivityValid() {
    ...
    public List<ProcessInfo> getxodosProcessorInfo(String tag) {
        if (xodosActivityListener != null) {
            return xodosActivityListener.collectProcessorInfo(tag);
        }
        return null;
    }

    protected interface xodosActivityListener {
    ...
    public xodosActivityListener getxodosActivityListener() {
        return xodosActivityListener;
    }

    protected xodosActivityListener xodosActivityListener;
...
//            .setCustomAnimations(R.anim.slide_in_right, R.anim.slide_out_left, R.anim.slide_in_left, R.anim.slide_out_right)
    ...
    public void installX11ServerBridge() {
        if (xodosActivityListener != null) {
            xodosActivityListener.reInstallX11StartScript(this);
        }
    }
...
private void performRestartSequence() {
   ...
   // Try each command separately
    String[] commands = {
        ...
        "pkill -f \"xodos.x11\""  // Alternative to kill -9 $(pgrep -f)
    };
...
*/
    ...
    public void stopDesktop() {
                ...
                //    performRestartSequence();
                            if (xodosActivityListener != null) {
            xodosActivityListener.stopDesktop();
        }
...
if (p.getKey().contentEquals("wine_settings")) {
    if (loriePreferences != null && loriePreferences.isActivityValid()) {
        ...
        try {
            Class<?> xoDosWizardClass = Class.forName("com.xodos.app.XoDosWizard");
        ...
        return true;
            ...
            */
            ...
            if (p.getKey().contentEquals("open_keyboard")) {
                handler.postDelayed(() -> {
                    if (loriePreferences != null) {
                        ...
                        loriePreferences.xodosActivityListener.openSoftwareKeyboard();
                    }
                }, 500);
            }
            ...
            if (p.getKey().contentEquals("open_progress_manager")) {
                loriePreferences.xodosActivityListener.showProcessManager();
            }
...
//            }});
            ...
            loriePreferences.xodosActivityListener.changePreference(key);
            return true;
        }
                ...
                new android.app.AlertDialog.Builder(getActivity())
                    ...
                    .setPositiveButton("OK",
                        (dialog, whichButton) -> {
                            ...
                            prefs.extra_keys_config.put(!text.isEmpty() ? text : xodosX11ExtraKeys.DEFAULT_IVALUE_EXTRA_KEYS);
                        }
                    )
                    .setNeutralButton("Reset",
                        (dialog, whichButton) -> prefs.extra_keys_config.put(xodosX11ExtraKeys.DEFAULT_IVALUE_EXTRA_KEYS))
                    .setNegativeButton("Cancel", (dialog, whichButton) -> dialog.dismiss())
                    .create()
    ...
    public static class Receiver extends BroadcastReceiver {
        ...
        private static void help() {
            System.err.print("xodos-x11-preference [list] {key:value} [{key2:value2}]...");
            System.exit(0);
        }
        ...
        public static void main(String[] args) {
            ...
            Intent i = new Intent("com.xodos.x11.CHANGE_PREFERENCE");
    ...
    private void callProgressManager() {
        if (xodosActivityListener != null) {
            xodosActivityListener.showProcessManager();
        }
    }
    ...
    protected void showInputControls(ControlsProfile controlsProfile) {
        ...
        if (xodosActivityListener != null) {
            xodosActivityListener.onX11PreferenceSwitchChange(false);
        }
    }
    ...
    public void prepareToExit() {
        if (xodosActivityListener != null) {
            xodosActivityListener.onExitApp();
        }
    }

    public void openPreference(boolean open) {
        if (xodosActivityListener != null)
            xodosActivityListener.onX11PreferenceSwitchChange(open);
    }

    public void releaseSlider(boolean release) {
        if (xodosActivityListener != null)
            xodosActivityListener.releaseSlider(release);
    }
}
