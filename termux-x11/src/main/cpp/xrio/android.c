...
JNIEXPORT void JNICALL Java_com_xodos_x11_XrActivity_init(JNIEnv *env, jobject obj) {
...
JNIEXPORT void JNICALL Java_com_xodos_x11_XrActivity_teardown(JNIEnv *env, jobject obj) {
    if (!xr_initialized) {
        return;
    }
...
JNIEXPORT jboolean JNICALL Java_com_xodos_x11_XrActivity_beginFrame(JNIEnv *env, jobject obj) {
...
JNIEXPORT void JNICALL Java_com_xodos_x11_XrActivity_finishFrame(JNIEnv *env, jobject obj) {
    XrRendererEndFrame(&xr_renderer);
    XrRendererFinishFrame(&xr_engine, &xr_renderer);
}

JNIEXPORT jfloatArray JNICALL Java_com_xodos_x11_XrActivity_getAxes(JNIEnv *env, jobject obj) {
...
JNIEXPORT jbooleanArray JNICALL Java_com_xodos_x11_XrActivity_getButtons(JNIEnv *env, jobject obj) {
...
JNIEXPORT jint JNICALL Java_com_xodos_x11_XrActivity_getRenderParam(JNIEnv *env, jobject obj, jint param) {
    return xr_params[param];
}

JNIEXPORT void JNICALL Java_com_xodos_x11_XrActivity_setRenderParam(JNIEnv *env, jobject obj, jint param, jint value) {
