...
import com.xodos.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        if (mClient.isTerminalViewSelected()) {
            if (mClient.shouldEnforceCharBasedInput()) {
                ...
                // https://github.com/xodos/xodos-app/issues/686
                ...
                // https://github.com/xodos/xodos-packages/issues/25
                // https://github.com/xodos/xodos-app/issues/87.
                // https://github.com/xodos/xodos-app/issues/126.
                // https://github.com/xodos/xodos-app/issues/137 (japanese chars and TYPE_NULL).
        ...
        // keyboard on Android TV (see https://github.com/xodos/xodos-app/issues/221).
     ...
     * https://github.com/xodos/xodos-app/pull/2237
     * https://github.com/agnostic-apollo/xodos-app/blob/terminal-code-point-custom-mapping/terminal-view/src/main/java/com/xodos/view/TerminalView.java
     *
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        // https://github.com/xodos/xodos-app/issues/731
     ...
     * {@link com.xodos.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.xodos.app.XodosActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
