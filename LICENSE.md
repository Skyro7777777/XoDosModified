The `xodos/xodos-app` repository is released under [GPLv3 only](https://www.gnu.org/licenses/gpl-3.0.html) license.
...
- Check [`xodos-shared/LICENSE.md`](xodos-shared/LICENSE.md) for `xodos-shared` library related exceptions.
