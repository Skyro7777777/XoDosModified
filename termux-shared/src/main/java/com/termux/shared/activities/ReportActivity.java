package com.xodos.shared.activities;
 ...
 * {@code `<activity android:name="com.xodos.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.xodosReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.xodos.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
    ...
    private void updateUI() {
        ...
        if (actionBar != null) {
            if (mReportInfo.reportTitle != null)
                ...
                actionBar.setTitle(xodosConstants.xodos_APP_NAME + " App Report");
        }
