package com.xodos.shared.shell.command;
...
public class ExecutionCommand {
    ...
    Only the {@link #errCode} being non-zero means that execution command failed from the xodos app
    perspective.
    */
     ...
     * commands. By default, @link com.xodos.shared.shell.StreamGobbler} only logs stdout and
    ...
    /** Defines the markdown text for the help of the xodos plugin API that was used to start the
     ...
     * like with an intent or from within xodos app itself. */
